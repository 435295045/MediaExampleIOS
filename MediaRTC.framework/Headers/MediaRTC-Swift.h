...
#ifndef MEDIARTC_SWIFT_H
#define MEDIARTC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MediaRTC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC8MediaRTC8DoorCall")
@interface DoorCall : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MediaRTC9GroupCall")
@interface GroupCall : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MediaRTC7P2PCall")
@interface P2PCall : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MediaRTC4Peer")
@interface Peer : NSObject <RTCDataChannelDelegate, RTCPeerConnectionDelegate>
...
@interface Peer (SWIFT_EXTENSION(MediaRTC))
...
SWIFT_CLASS("_TtC8MediaRTC8RoomCall")
@interface RoomCall : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
